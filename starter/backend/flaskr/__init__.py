...
def create_app(test_config=None):
  ...
  def add_questions():
    try:
      ...
      new_question= Question(question=q,answer=answer,category=Cat,difficulty=difficulty)
      new_question.insert()
  ...
  def search():
    ...
    print('ssssssssssssssssssss',search_term)
  ...
  def play_quiz():
    try:
      ...
      print('previous_questions_ids',previous_questions_ids)
